...
function printName(myName) {
  // const result = myName + " " + myName;
  console.log(myName + " " + myName);
}
const result = printName("Embla");
...
let helloGreet = printGreeting("Bob");
helloGreet = printGreeting("Sue");
...
function multiply(myNumber1, myNumber2) {
  const value = myNumber1 * myNumber2;
  return value;
}
const first = multiply(2, 2);
console.log(first);
